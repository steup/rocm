...
src_prepare() {
	...
	sed -i 's/CL_EXT_SUFFIX/CL_API_SUFFIX/' amdocl/cl_icd_amd.h amdocl/cl_ext.h rocclr/cl_lqdflash_amd.h
	sed -i 's/CL_EXT_SUFFIX/CL_API_SUFFIX/' amdocl/CL/cl_icd_amd.h amdocl/CL/cl_ext.h
}
